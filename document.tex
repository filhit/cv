...
\begin{document}
  ...
  \begin{minipage}[t]{0.55\textwidth}
    ...
    \begin{itemize}
      \item Created a system to present data in charts and tables. Reports were available online and as PDF, PowerPoint and Excel documents. It was programmed for internal corporate usage by pharmaceuticals companies.
    \end{itemize}
  \end{minipage}
\end{document}