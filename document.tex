...
{\daterange{2016-04-01}{2017-02-06}}
{Software Engineer}
{Munich, Germany}
\item Developed Windows desktop application and a Microsoft Outlook add-in for file sync 
and share service. Extracted and supported a portable library that was used by four 
client applications on different mobile and desktop platforms. 
\item Introduced and implemented code review process, migrated code from TFVC to Git, 
started automated UI testing.
\item Solution stack:
  .NET,
  C\#, 
  MEF,
...
two weeks.
\item Completely rebuilt the user interface of the application and made it fast,
